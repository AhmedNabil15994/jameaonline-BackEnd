...
$ConstProjectName = 'TakeLookApp';

return [
    'name' => 'Core',
    'image_mimes' => 'jpeg,png,jpg,gif,svg',
    'image_max' => '2048',
    'special_images' => ['default.png', 'default.jpg', 'user.png', 'storage/photos/shares/vendors/default.jpg'],
    ...
    'vendor_requests_img_path' => 'uploads/vendor_requests',
