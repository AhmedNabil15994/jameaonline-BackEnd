...
Route::group(['prefix' => 'users/deactivate'], function () {
    Route::get('/', 'FrontEnd\UserController@deactivate_page')
        ->name('frontend.users.deactivate_page');

    Route::post('/', 'FrontEnd\UserController@deactivate')
        ->name('frontend.users.deactivate');
