                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{ __('catalog::dashboard.products.form.product_flag') }}
                                                                </label>
                                                                <select name="product_flag" class="form-control">
                                                                    <option value="">
                                                                        ---
                                                                        {{ __('catalog::dashboard.products.form.select_product_flag') }}
                                                                        ---
                                                                    </option>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('catalog::dashboard.products.datatable.product_flag') }}</th>
...
responsivePriority:1,
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                @if (config('setting.products.toggle_addons') == 1)
                                    addonsBtn += `<a href="` + addOnsUrl + `" class="btn btn-sm green" title="Add Ons"><i class="fa fa-plus"></i></a>`;
                                @endif
