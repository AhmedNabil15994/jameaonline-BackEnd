                        ...
                        <div class="form-check text-center">
                            <div class="mt-radio-inline">
                                <label class="mt-radio">
                                    <input type="radio" name="product_flag" value="product"
                                        {{ $product->product_flag == 'product' ? 'checked' : '' }}
                                ...
                                <label class="mt-radio">
                                    <input type="radio" name="product_flag" value="meal"
                                        {{ $product->product_flag == 'meal' ? 'checked' : '' }}
                                ...
                                <label class="mt-radio">
                                    <input type="radio" name="product_flag" value="service"
                                        {{ $product->product_flag == 'service' ? 'checked' : '' }}
                                                ...
                                                @if (config('setting.products.toggle_variations') == 1)
                                                    <li class="">
                                                        <a href="#variations" id="click-varaition" data-toggle="tab"
                                                            style="display: {{ in_array($product->product_flag, ['meal', 'service']) ? 'none' : 'block' }}">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div id="global_setting{{ $code }}"
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description[{{ $code }}]" rows="8"
                                                                cols="80" class="form-control {{ is_rtl($code) }}Editor"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="preparation_time[{{ $code }}]"
                                                                class="form-control"
                                                                data-name="preparation_time.{{ $code }}"
                                                                value="{{ $product->getTranslation('preparation_time', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="requirements[{{ $code }}]"
                                                                class="form-control"
                                                                data-name="requirements.{{ $code }}"
                                                                value="{{ $product->getTranslation('requirements', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="duration_of_stay[{{ $code }}]"
                                                                class="form-control"
                                                                data-name="duration_of_stay.{{ $code }}"
                                                                value="{{ $product->getTranslation('duration_of_stay', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group" id="shipmentGroup"
                                                style="display: {{ $product->product_flag == 'product' ? 'block' : 'none' }}">
                                    ...
                                    <div id="stock-content">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" step="0.001" min="0" name="price" class="form-control"
                                                        data-name="price"
                                            ...
                                            <div class="form-group" id="qtySection"
                                                style="display: {{ $product->product_flag == 'service' ? 'none' : 'block' }}">
                                                <label class="col-md-2">
                                            ...
                                            <div class="offer-form" style="display:none;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" step="0.001" min="0" id="offer-form" name="offer_price"
                                ...
                                @if (config('setting.products.toggle_variations') == 1)
                                    <div class="tab-pane fade in" id="variations">
                                        <div id="variations-content"
                                            style="display: {{ !in_array($product->product_flag, ['meal', 'service']) ? 'block' : 'none' }}">
                                            ...
                                            <div id="seo_{{ $code }}"
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="seo_keywords[{{ $code }}]" rows="8"
