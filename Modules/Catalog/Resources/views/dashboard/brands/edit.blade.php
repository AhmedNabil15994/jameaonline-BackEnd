...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.brands.update',$brand->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{ $brand->getTranslation('title',$code) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small" name="status" {{($brand->status == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade in" id="seo">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_keywords.{{$code}}">{{ $brand->getTranslation('seo_keywords',$code) }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="seo_description[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_description.{{$code}}">{{ $brand->getTranslation('seo_description',$code) }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
