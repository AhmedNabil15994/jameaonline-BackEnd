                    ...
                    @if (is_array($value2))
                        <tr>
                            <td colspan="6" style="padding: 15px;">
                                @foreach ($value2 as $optionValue)
                                    <input type="hidden" name="option_values_id[{{ $key2 }}][]"
                                        value="{{ $optionValue }}">
                                    <span>
                        ...
                        <tr role="row" class="filter " data-key="{{ $key2 }}">
                            <td>
                                ...
                                <input type="number" step="0.001" min="0" placeholder="Price"
                                    data-name="variation_price.{{ $key2 }}"
                                    class="form-control form-filter input-sm"
                                    name="variation_price[{{ $key2 }}]">
                            ...
                            <td>
                                ...
                                <input type="text" placeholder="SKU" data-name="variation_sku.{{ $key2 }}"
                                    class="form-control form-filter input-sm" value="{{ generateRandomCode() }}"
                            ...
                            <td>
                                ...
                                <span class="holder" style="margin-top:15px;max-height:100px;"></span> --}}
                                    ...
                                    <input name="v_images[{{ $key2 }}]"
                                        data-name="v_images.{{ $key2 }}"
                                    ...
                                    <span class="holder" style="margin-top:15px;max-height:100px;">
                                        <img id="imgUploadPreview-{{ $key2 . '-var-' . ($key2 + 1) }}" src="#"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 text-left">
                                        <input type="checkbox" class="offer-status" data-index="{{ $key2 }}"
                                            name="v_offers[{{ $key2 }}][status]"
                                            data-name="v_offers.{{ $key2 }}.status">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <input type="number" step="0.001" min="0"
                                                        ...
                                                        id="offer-form_v"
                                                        data-name="v_offers.{{ $key2 }}.offer_price"
                                                        class="form-control"
                                                        name="v_offers[{{ $key2 }}][offer_price]" disabled>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group input-medium date date-picker"
                                                        ...
                                                        <input type="text" id="offer-form_v" class="form-control"
                                                            ...
                                                            data-name="v_offers.{{ $key2 }}.start_at"
                                                            disabled>
                    ...
                    @else
                        ...
                        @endforeach --}}
                            ...
                            <input type="hidden" name="option_values_id[{{ $key2 }}][]"
                                value="{{ $value2 }}">
                            <span>
                                {{ $optionValues->findOptionValueById($value2, ['translations', 'option.translations'])->option->title }}
                                : </span>
                            <b>{{ $optionValues->findOptionValueById($value2, ['translations'])->title }}</b>
                            ...
                            <td>
                                <div class="form-group" style="margin: 0">
                                    ...
                                    <input type="text" placeholder="SKU"
                                        ...
                                        value="{{ generateRandomCode() }}" class="form-control form-filter input-sm"
                                        name="variation_sku[{{ $key2 }}]">
                                    <div class="help-block"></div>
                                </div>
                            </td>
