        ...
        switch ($this->getMethod()) {
            ...
            case 'PUT':
                ...
                if ($this->offer_status) {
                    ...
                    $res['start_at'] = 'nullable|date';
                    $res['end_at'] = 'nullable|date';
                }
                ...
                if ($this->v_offers) {
                    ...
                    $res['v_offers.*.start_at'] = 'nullable|date';
                    $res['v_offers.*.end_at'] = 'nullable|date';
                }
                ...
                if ($this->_v_offers) {
                    ...
                    $res['_v_offers.*.start_at'] = 'nullable|date';
                    $res['_v_offers.*.end_at'] = 'nullable|date';
                }
