                ...
                <table class="table table-striped table-bordered table-hover" id="dataTable">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>{{__('vendor::dashboard.delivery_charges.datatable.vendor')}}</th>
            ...
            <div class="row">
                <div class="form-group">
                    <button type="submit" id="deleteChecked" class="btn red btn-sm"
                        onclick="deleteAllChecked('{{ url(route('dashboard.vendor_delivery_charges.deletes')) }}')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.vendor_delivery_charges.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'delivery_charges', className: 'dt-center', orderable: false},
                        {data: 'id'},
                    ],
                    columnDefs: [
                        {
...
responsivePriority:1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Edit
                                var editUrl = '{{ route("dashboard.vendor_delivery_charges.edit", ":id") }}';
